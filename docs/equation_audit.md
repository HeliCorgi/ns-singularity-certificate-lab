...
数値検算(`poisson.py`、\(z\) 非依存 source、\(a=0.95\)):
\(R=1\to2\) の core 差は測定値 \(-1.6969516537\times10^{-3}\) で
\(r\) について定数(広がり/値 \(=8.6\times10^{-14}\))、閉形式予測
\(-1.6968880208\times10^{-3}\) と相対 \(3.8\times10^{-5}\) 一致
(離散化誤差水準)。\(R=2\to4\) も同様(相対 \(4.1\times10^{-5}\))。
単一モード source での \(R\) 減衰比は、\(L_z=1,2,4\)
(\(k=2\pi,\pi,\pi/2\))で実測 557.6/546.2、25.3/24.2、5.98/5.48 に対し
(E-33d) 先頭項の予測 535.5、23.1、4.81。
