...
\title{A bandwidth--dissipation dichotomy for the three-dimensional
periodic Navier--Stokes equations, with an exact action representation}
...
appendix and support only the conditional hypothesis.
\end{abstract}
